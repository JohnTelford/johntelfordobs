...
The guardian and stakeholders may choose to [Rollback](glossary#rollbacks) the production deployment to a previous production deployment if triage determines the remediation time is unacceptable.
